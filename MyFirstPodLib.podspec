...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/amit.rawat/MyFirstPodLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'amit.rawat' => 'amit.rawat@int.absas.net' }
  s.source           = { :git => 'https://github.com/amit.rawat/MyFirstPodLib.git', :tag => s.version.to_s }
